...
def add_song(itunes_identifier, myvars):
    ...
    headers = {
        # The Apple Store Front value also should be checked from Charles if you get error "HTTP Error 400: Apple WebObjects"
        "X-Apple-Store-Front" : "143446-2,32",
        "Client-iTunes-Sharing-Version" : "3.12",
        "Accept-Language" : "en;q=1.0, nl;q=0.9",
        ...
        "User-Agent" : "iTunes/12.6 (Macintosh; OS X 10.11.6) AppleWebKit/601.7.8",
